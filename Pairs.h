void PairsStrategy(const vector<Record>& data1, const vector<Record>& data2, int start, int x, int n, double threshold, vector<Order>& orderStatistics1, vector<Order>& orderStatistics2, ofstream& cashflowFile, ofstream& orderStatisticsFile1, ofstream& orderStatisticsFile2, ofstream& finalPNLFile) {
